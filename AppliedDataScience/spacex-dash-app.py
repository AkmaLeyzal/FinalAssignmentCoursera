...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Untuk semua sites, tampilkan total successful launches per site
        fig = px.pie(
        ...
        # Untuk site tertentu, tampilkan Success vs Failed
...
def get_scatter_chart(entered_site, payload_range):
    # Filter berdasarkan payload range
    ...
    if entered_site == 'ALL':
        # Scatter plot untuk semua sites
        fig = px.scatter(
            filtered_df,
            x='Payload Mass (kg)',
            y='class',
        ...
        # Scatter plot untuk site tertentu
